      ...
      <Navbar className="app-header header top-header">
        <div className="container-fluid main-container">
          <div className="d-flex">
            ...
            <Link className="header-brand" to={`${import.meta.env.BASE_URL}dashboard/dashboard01`}>
              <img
                src={logo}
                  ...
                  <div className="d-flex" >
                    ...
                    <UncontrolledDropdown className="dropdown header-notify">
                      ...
                      <DropdownMenu className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        <DropdownItem
                          href={`${import.meta.env.BASE_URL}pages/email/emailinbox/`}
                        ...
                        <div className=" text-center p-2 border-top">
                          <Link to={`${import.meta.env.BASE_URL}pages/email/emailinbox/`} className="">
                    ...
                    <UncontrolledDropdown className="dropdown profile-dropdown">
                      ...
                      <DropdownMenu className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <DropdownItem
                          ...
                          href={`${import.meta.env.BASE_URL}pages/profile/profile01/`}
                        >
                          <svg
                        ...
                        <DropdownItem
                        href={`${import.meta.env.BASE_URL}Auth/Login/Login`}
                          className="dropdown-item d-flex"
