...
export function checkHoriMenu() {
  ...
  let mainSidemenuWidth = document.querySelector(
    ".main-sidemenu"
  ) as HTMLElement;
...
export function localStorageBackUp() {
  ...
  if (localStorage.getItem("dashticPrimaryColor") !== null) {
    ...
    let mySwitch5 = document.getElementById(
      "myonoffswitch1"
    ) as HTMLInputElement;
  ...
  if (localStorage.getItem("dashticdarkPrimaryColor") !== null) {
    ...
    let mySwitch6 = document.getElementById(
      "myonoffswitch2"
    ) as HTMLInputElement;
  ...
  if (localStorage.dashticrtl) {
    ...
    document.querySelector("body")?.classList.remove("ltr");
    let mySwitch7 = document.querySelector(
      "#myonoffswitch55"
    ) as HTMLInputElement;
  ...
  if (localStorage.dashtichorizontal) {
    ...
    document.querySelector(".app-sidebar")?.classList.add("horizontal-main");
    document.querySelector(".side-app")?.classList.add("container");
    let hori = document.querySelector(
      ".horizontal .side-menu"
    ) as HTMLInputElement;
    hori.style.flexWrap = "nowrap";
    let mySwitch8 = document.querySelector(
      "#myonoffswitch35"
    ) as HTMLInputElement;
  ...
  if (localStorage.dashtichorizontalHover) {
    ...
    document.querySelector("body")?.classList.remove("sidebar-mini");
    document.querySelector("body")?.classList.remove("sidenav-toggled");
    let muSwitch9 = document.querySelector(
      "#myonoffswitch111"
    ) as HTMLInputElement;
  ...
  if (localStorage.dashticdark) {
    let mySwitch9 = document.querySelector(
      "#myonoffswitch2"
    ) as HTMLInputElement;
  ...
  if (localStorage.dashticlighttheme) {
    let mySwitch10 = document.querySelector(
      "#myonoffswitch1"
    ) as HTMLInputElement;
  ...
  if (localStorage.DashticBGswitcher) {
    const dynamicBackgroundColor: NodeListOf<Element> =
      document.querySelectorAll("input.background-primary-light");
  ...
  if (localStorage.dashticPrimaryColor) {
    ...
    dynamicLightPrimaryColor(
      dynamicPrimaryLight,
      localStorage.dashticprimaryBorderColor
    );
  }
}
...
export function dynamicLightPrimaryColor(
  primaryColor: NodeListOf<Element>,
  color: string
) {
...
export function dynamicBgTransparentBackground(
  primaryColor: Element[] | NodeListOf<Element>,
  color: string
) {
  primaryColor.forEach((item: Element) => {
