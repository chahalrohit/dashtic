            ...
            <Row className=" justify-content-center mt-7 mt-sm-0" onClick={() => { switcherIconReomve() }}>
                <Col xl={8} lg={9}>
                                ...
                                <div className="w-100">
                                    ...
                                    <div className="mb-3">
                                        <Label className="custom-control custom-checkbox">
                                            ...
                                            <span className="custom-control-label">Agree the <Link to={`${import.meta.env.BASE_URL}pages/terms`}>terms and policy</Link></span>
                                        </Label>
                                    </div>
                                    <Row className="row">
                                        <Col className="col-12">
                                            <Link role="button" to={`${import.meta.env.BASE_URL}dashboard/dashboard01`} className="btn btn-lg btn-primary btn-block px-4"><i className="fe fe-arrow-right"></i> Send</Link>
                                        </Col>
                                    </Row>
                                </div>
                            </CardBody>
                    ...
                    <div className="text-center pt-4">
                        <div className="font-weight-normal fs-16">Forget it <Link className="btn-link font-weight-normal" to={`${import.meta.env.BASE_URL}dashboard/dashboard01`}>Send me back</Link></div>
                    </div>
                </Col>
            </Row>
