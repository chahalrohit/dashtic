									...
									<Col md={8} className=" mx-auto d-block">
										...
										<div className="mb-3">
											<Label className="custom-control custom-checkbox">
												...
												<span className="custom-control-label">Agree the <Link to={`${import.meta.env.BASE_URL}pages/terms`} className="btn-link">terms and policy</Link></span>
											</Label>
										</div>
										<Row>
											<Col className="col-12">
												<Link role="button" to={`${import.meta.env.BASE_URL}dashboard/dashboard01`} className="btn btn-lg btn-primary btn-block px-4"><i className="fe fe-arrow-right"></i> Create a new account</Link>
											</Col>
										</Row>
										<div className="pt-4">
											<div className="font-weight-normal fs-16">You Already have an account <Link className="btn-link font-weight-normal" to={`${import.meta.env.BASE_URL}account/login/login02`}>Login Here</Link></div>
										</div>
									</Col>
								</Row>
							</CardBody>
