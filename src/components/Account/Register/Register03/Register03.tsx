			...
			<Row className=" justify-content-center mt-7 mt-sm-0" onClick={() => { switcherIconReomve() }}>
				<Col xxl={8} lg={9}>
					...
					<div className="text-center pt-4">
						<div className="font-weight-normal fs-16">You Already have an account <Link className="btn-link font-weight-normal" to={`${import.meta.env.BASE_URL}account/login/login03`}>Login Here</Link></div>
					</div>
				</Col>
			</Row>
		</div>
