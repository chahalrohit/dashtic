                                        ...
                                        <div className="mt-3 mt-sm-0">
                                            ...
                                            <Row>
                                                <Col className="col-12">
                                                    <Link role="button" to={`${import.meta.env.BASE_URL}dashboard/dashboard01`} className="btn  btn-lg btn-primary btn-block px-4"><i className="fe fe-arrow-right"></i> Reset</Link>
                                                </Col>
                                            </Row>
                                        </div>
                                        <div className="pt-4">
