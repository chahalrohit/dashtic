								...
								<Row>
									<Col md={8} className="mx-auto d-block">
										...
										<Row>
											...
											<Col className="col-12">
												<Link role="button" to={`${import.meta.env.BASE_URL}dashboard/dashboard01`} className="btn btn-primary btn-block"> <i className="fe fe-arrow-right"></i> Login</Link>
											</Col>
										</Row>
										<div className="pt-4">
											<div className="font-weight-normal fs-16">You Don't have an account <Link className="btn-link font-weight-normal" to={`${import.meta.env.BASE_URL}account/register/register02`}>Register Here</Link></div>
										</div>
									</Col>
								</Row>
							</CardBody>
