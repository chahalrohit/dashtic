    ...
    <Row>
      ...
      <Col lg="8" xl="9" md="12" sm="12">
        <Card>
            ...
            <Form>
              <div className="mb-3">
                <Row className="align-items-center">
                  <Label className="col-sm-2 form-label">To</Label>
                  <Col sm="10">
              ...
              <div className="mb-3">
                <Row className="align-items-center">
                  <Label className="col-sm-2 form-label">Subject</Label>
                  <Col sm="10">
                    <Input type="text" className="form-control" />
                  </Col>
                </Row>
          ...
          <CardFooter className=" d-sm-flex">
            <div className="mt-2 mb-2">
              <Link
                to="#"
                className="btn btn-icon btn-white btn-svg me-1"
              ...
              <UncontrolledTooltip target="Attach" placement="top">
                Attach
              </UncontrolledTooltip>
              <Link
                to="#"
              ...
              <UncontrolledTooltip target="Links" placement="top">
                Link
              </UncontrolledTooltip>
              <Link
                to="#"
              ...
              <UncontrolledTooltip target="Photos" placement="top">
                Photos
              </UncontrolledTooltip>
              <Link
                to="#"
