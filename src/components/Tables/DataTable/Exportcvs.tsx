...
function convertArrayOfObjectsToCSV(array:any) {
  ...
  const Export = ({ onExport }:any) => (
    <Button color="" className="btn btn-primary me-0" onClick={(e:any) => onExport(e.target.value)}>Export</Button>
  );
  ...
  export const ExportCSV = () => {
    const actionsMemo = React.useMemo(() => <Export onExport={() => downloadCSV(allData)} />, []);
